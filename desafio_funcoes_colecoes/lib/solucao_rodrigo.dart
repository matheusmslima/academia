void main() {
  ...
  print('A pessoa mais velha é ${pessoaMaisVelha[0]} e ela tem ${pessoaMaisVelha[1]} anos.');
  print('A pessoa mais nova é ${pessoaMaisNova[0]} e ela tem ${pessoaMaisNova[1]} anos.');  
}
